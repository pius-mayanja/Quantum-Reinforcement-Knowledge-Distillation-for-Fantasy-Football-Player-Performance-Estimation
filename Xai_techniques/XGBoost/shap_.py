...
# SHAP Analysis with actual feature names
...
# Dependence plots (example for the top 3 features)
top_features = [features[i] for i in abs(shap_values).mean(0).argsort()[-3:]]
for feature in top_features:
    shap.dependence_plot(feature, shap_values, X_scaled)
